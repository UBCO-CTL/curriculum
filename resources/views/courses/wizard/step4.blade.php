                ...
                <div class="card mt-4" style="position:static">
                    ...
                    <div class="card-body">
                        <div class="alert alert-primary d-flex align-items-center" role="alert" style="text-align:justify">
                            ...
                            <div>
                                This step, requires instructors to intentionally evaluate all course elements to achieve course alignment. This means, ensuring that the targeted learning outcomes are in alignment with the assessment methods and teaching/instructional practices. You can review <a class="alert-link" target="_blank" rel="noopener noreferrer" href="https://www.tcd.ie/media/tcd/academic-practice/pdfs/Linking_assessment_methods_with_learning_outcomes_260421.pdf"><i class="bi bi-box-arrow-up-right"></i>this resource</a> for more information on linking assessment methods and learning outcomes. This can be an iterative process and may take a long time. Intentional evaluation and re-thinking of some course elements is encouraged to achieve better alignment. <b>Review CLOs/competencies you have identified, and map assessment methods to teaching and learning activities to initiate curriculum alignment.</b>
                            </div>
                        </div>
