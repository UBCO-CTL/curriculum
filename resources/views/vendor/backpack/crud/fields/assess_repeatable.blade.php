...
@if ($crud->fieldTypeNotLoaded($field))
  ...
  @push('crud_fields_styles')
      ...
      <style type="text/css">
        ...
        .hidden-label div, .hidden-label table, .hidden-label td{
            margin: 0;
            padding:0;
        }
