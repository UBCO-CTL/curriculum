<!--  relationship. Purpose of this customization is to allow inline creates on pivot records. It didnt work, so this can be removed without issue -->
...
<select
        ...
        data-connected-entity-key-name="{{ isset($field['variable_key'])? $field['variable_key'] : $connected_entity_key_name }}"
